...
const api: AppApi = {
  ...
  data:{ backup:()=>ipcRenderer.invoke("data:backup"), restore:()=>ipcRenderer.invoke("data:restore"), exportJson:()=>ipcRenderer.invoke("data:export-json"), exportBuilds:()=>ipcRenderer.invoke("data:export-builds"), importBuilds:()=>ipcRenderer.invoke("data:import-builds"), exportTeams:()=>ipcRenderer.invoke("data:export-teams"), importTeams:()=>ipcRenderer.invoke("data:import-teams") },
};
