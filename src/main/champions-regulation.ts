export const POKEMON_CHAMPIONS_REGULATION_KEY = "pokemon-champions-active-208";
...
export const pokemonChampionsActiveSpecies = [
  ...
  "avalugg", "noivern", "decidueye", "incineroar", "primarina", "toucannon", "wishiwashi", "lycanroc", "toxapex", "mudsdale",
  "araquanid", "salazzle", "tsareena", "passimian", "oranguru", "mimikyu", "drampa", "kommo-o", "corviknight", "flapple",
  "appletun", "sandaconda", "polteageist", "hatterene", "grimmsnarl", "mr-rime", "runerigus", "alcremie", "falinks", "morpeko",
  "dragapult", "wyrdeer", "kleavor", "basculegion", "sneasler", "overqwil", "meowscarada", "skeledirge", "quaquaval", "maushold",
  "garganacl", "armarouge", "ceruledge", "bellibolt", "arboliva", "espathra", "tinkaton", "palafin", "orthworm", "glimmora",
  "houndstone", "annihilape", "farigiraf", "kingambit", "gholdengo", "poltchageist", "archaludon", "hydrapple"
] as const;
